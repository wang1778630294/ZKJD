...
(function(exports) {
	...
	*/
	...
	function createWebsocket(){
		var socket = new WebSocket("wss://xzdqnavi.powerlbs.com/wechat/locationShare");
		...
		if (pointdata) {
			...
			for (var i=0; i<pointdata.length;i++) {
				...
				function base64(pointdata,i){
					...
					var pointdatafloor = pointdata[i].floor ? pointdata[i].floor : 0;
							
					var msg = {
						floor: pointdatafloor,
						x: pointdatax,
						y: pointdatay,
					...
					/*if (globalData.isFirstLoction == 0 &&msg.floor) {
						globalData.isFirstLoction++;
						moveToCenter(msg);
					}
					// 如果楼层切换
					if (floorArr[myLocPoint.floor] != globalData.last_located_floor_id) {
						moveToCenter(msg);
						// 记录上次的楼层ID
